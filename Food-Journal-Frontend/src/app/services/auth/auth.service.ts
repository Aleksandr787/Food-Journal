...
export class AuthService implements OnInit {
  ...
  public loadUserParametrs(): void {
    this.getUserParametrs().subscribe((res) => {
      this.userParametrs = res;
      this.userStandarts = this.calculateCalorieIntake(res);
    });
  }
  ...
  public dialogUpdateUserParametrs(): void {
    const dialogRef = this._dialog.open(UpdateUserParametrsComponent, { data: this.userParametrs });
